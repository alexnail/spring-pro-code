...
public class AccountController {
	...
	private ResponseEntity<Void> entityWithLocation(Object resourceId) {
		...
		var locationUri = ServletUriComponentsBuilder// Return something other than null
	...
	public ResponseEntity<Void> addBeneficiary(@PathVariable long accountId, @RequestBody String beneficiaryName) {
		...
		// TODO-11: Create a ResponseEntity containing the location of the newly created beneficiary.
		...
		var locationUri = ServletUriComponentsBuilder
				...
				.buildAndExpand(beneficiaryName)
				.toUri();;

		return ResponseEntity.created(locationUri).build();  // Modify this to return something
	}
