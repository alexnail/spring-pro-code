...
public class RewardsConfig {
	...
	public AccountRepository accountRepository() {
		var jdbcAccountRepository = new JdbcAccountRepository();
	...
	public RestaurantRepository restaurantRepository() {
		var jdbcRestaurantRepository = new JdbcRestaurantRepository();
	...
	public RewardRepository rewardRepository() {
		var jdbcRewardRepository = new JdbcRewardRepository();
