...
public class AccountClientTests {
	...
	// - Remove the "assertThrows" statement (since you are not going to check if an exception is thrown)
	// - Use "getForEntity" method (instead of "getForObject" method) of "TestRestTemplate"
	...
	public void addAndDeleteBeneficiary() {
		...
		var entity = restTemplate.getForEntity(newBeneficiaryLocation, Beneficiary.class);
	...
	// - Note how long it takes for this test to finish - it is in the range of several seconds
